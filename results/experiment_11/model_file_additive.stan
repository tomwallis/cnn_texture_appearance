...
model { 
  ...
  for (n in 1:N) { 
    eta[n] = eta[n] + (r_1_1[J_1[n]]) * Z_1_1[n] + (r_1_2[J_1[n]]) * Z_1_2[n] + (r_1_3[J_1[n]]) * Z_1_3[n] + (r_1_4[J_1[n]]) * Z_1_4[n] + (r_1_5[J_1[n]]) * Z_1_5[n] + (r_1_6[J_1[n]]) * Z_1_6[n] + (r_1_7[J_1[n]]) * Z_1_7[n] + (r_2_1[J_2[n]]) * Z_2_1[n] + (r_2_2[J_2[n]]) * Z_2_2[n] + (r_2_3[J_2[n]]) * Z_2_3[n] + (r_2_4[J_2[n]]) * Z_2_4[n] + (r_2_5[J_2[n]]) * Z_2_5[n] + (r_2_6[J_2[n]]) * Z_2_6[n] + (r_2_7[J_2[n]]) * Z_2_7[n]; 
  } 
