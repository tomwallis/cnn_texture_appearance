...
orig_im_path = fullfile(filepathToHere, sprintf('../../stimuli/stimulus_set_3/preprocessed_ims/'));
ps_path = fullfile(filepathToHere, sprintf('../../stimuli/stimulus_set_3/ps_synths/'));
conv1_path = fullfile(filepathToHere, sprintf('../../stimuli/stimulus_set_3/conv1/'));
conv2_path = fullfile(filepathToHere, sprintf('../../stimuli/stimulus_set_3/conv2/'));
conv3_path = fullfile(filepathToHere, sprintf('../../stimuli/stimulus_set_3/conv3/'));
conv4_path = fullfile(filepathToHere, sprintf('../../stimuli/stimulus_set_3/conv4/'));
conv5_path = fullfile(filepathToHere, sprintf('../../stimuli/stimulus_set_3/conv5/'));
...
[im_code, image_model] = BalanceFactors(n_reps, 1, im_code, {'conv1', 'conv2', 'conv3', 'conv4', 'conv5', 'PS'});
...
%% Some subfunctions
    ...
    function fname = get_model_im(im_code, image_model, version)
        if strcmp(image_model, 'conv1')
            fname =  char(fullfile(conv1_path, sprintf(...
                '%s_version%d.png', im_code, version)));
        elseif strcmp(image_model, 'conv2')
            fname =  char(fullfile(conv2_path, sprintf(...
                '%s_version%d.png', im_code, version)));
        elseif strcmp(image_model, 'conv3')
            fname =  char(fullfile(conv3_path, sprintf(...
                '%s_version%d.png', im_code, version)));
        elseif strcmp(image_model, 'conv4')
            fname =  char(fullfile(conv4_path, sprintf(...
                '%s_version%d.png', im_code, version)));
